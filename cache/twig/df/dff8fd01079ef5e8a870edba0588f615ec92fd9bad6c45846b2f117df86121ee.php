...
class __TwigTemplate_3bf320579fb9b8340216a6b9f82fbee2278e0fb90565442347168cf415570e02 extends Twig_Template
{
    ...
    ";
        // line 2
        if (($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "sidebar_position", array()) != "none")) {
            // line 3
        ...
        ";
        // line 5
        if (($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "sidebar_position", array()) == "left")) {
            // line 6
            echo "            ";
            if (($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "sidebar_position", array()) != "none")) {
                // line 7
        ...
        ";
        // line 18
        if ((($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "sidebar_position", array()) == "right") || ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "sidebar_position", array()) == "none"))) {
            // line 19
            echo "            ";
            if (($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "sidebar_position", array()) != "none")) {
                // line 20
    ...
    {
        return new Twig_Source("<section class=\"wrapper style4 container\">
    ...
    {% endif %}
</section>", "modular/sidebar.html.twig", "E:\\emmanuelchristianchurch\\user\\themes\\twenty\\templates\\modular\\sidebar.html.twig");
    }
}
